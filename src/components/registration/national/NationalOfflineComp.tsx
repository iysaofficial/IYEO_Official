...
const NationalOfflineComp: React.FC = () => {
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbwebNQy6aKWCvzTa98SxKLlC55Blx-6m5RoR-sInZPTK4VUbpOIHEU0d3Cr-Xtrg3MJ/exec";
...
const HeaderSection: React.FC = () => (
  <div className="header-section">
    <div className="header-content">
      ...
      <h2 className="event-title">IYEO 2026</h2>
    </div>
  </div>
);
...
const InstructionSection: React.FC = () => (
  <div className="instruction-section">
    <h3 className="instruction-title">
      HELLO IYEO 2026 PARTICIPANTS, Please consider the following information before filling out the registration form :
    </h3>
...
const InformasiUmumSection: React.FC = () => (
  <section className="form-section">
    ...
    <div className="field-grid">
      ...
      <div className="field-group">
        <label className="field-label">IYEO 2026 Competition Information Resources</label>
