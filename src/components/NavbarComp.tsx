    ...
    return(
        ...
        <header>
            <Link href="/">
                <Image 
                    className='logo-nav' 
                    src="/assets/images/logo/IYEO.png" 
                    alt="IYEO Logo" 
                    width={100} 
                    height={50}
                    priority
            ...
            <div className='navigation'>
                <ul className='menu'>
                    ...
                    <li className='menu-item'>
                        <Link href="https://drive.google.com/file/d/1XrDQQnRKNuQNJiv6MrdMxmMi7ruYAKya/view?usp=sharing" 
                            target='_blank'
                    ...
                    <li className='menu-item'>
                        ...
                        <ul className='sub-menu'>
                            <li className='sub-item'>
                                <Link href="https://drive.google.com/drive/folders/1DALx9JV69oAaMEqJMP0dUoHjiQtGEiEP?usp=sharing" 
                                    target='_blank'
                                    rel="noopener noreferrer">
                            ...
                            <li className='sub-item'>
                                <Link href="https://drive.google.com/drive/folders/1l_bCazIZmdtOSUjAuBAgXTg7YEBTixPY?usp=sharing" 
                                    target='_blank'
                                    rel="noopener noreferrer">
                    ...
                    <li className='menu-item'>
                        ...
                        <ul className='sub-menu'>
                            ...
                            <li className='sub-item'>
                                <Link href="https://drive.google.com/drive/folders/1oZ-cr_-NdV8Gd2pUVLnrGCT9jYA0gz2v?usp=sharing" 
                                    target='_blank' 
                                    rel="noopener noreferrer">
                                        2023
                                </Link>
